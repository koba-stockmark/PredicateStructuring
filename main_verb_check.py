...
#        elif len(doc) > doc[predic_head].i + 1 and doc[predic_head].pos_ == 'NOUN' and doc[doc[predic_head].head.i].dep_ == 'ROOT' and (doc[doc[predic_head].i + 1].pos_ == 'AUX' or doc[doc[predic_head].i + 1].pos_ == 'PUNCT'):  # 〇〇します。 がROOTになっていないときの例外処理
            ...
            rule_id = 122
        elif (doc[predic_head].pos_ == 'ADP' or doc[predic_head].pos_ == 'PART') and doc[doc[predic_head].head.i].dep_ == "ROOT":  # 体言どめ + 助詞
            rule_id = 123
            ...
            rule_id = 126
        elif doc[predic_head].pos_ == 'VERB' and predic_head + 1 < len(doc) and doc[predic_head + 1].pos_ != 'ADP' and doc[doc[predic_head].head.i].pos_ == 'ADJ' and doc[doc[predic_head].head.i].dep_ == "ROOT":  # 形容詞語幹 + 動詞
            rule_id = 127
