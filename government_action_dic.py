class GovernmentActionRule:
    ...
    # 検討審議
    kentou_dic = [
        "審議", "判断", "可否", "審査", "諮問", "検討", "試算", "見直す", "継続審議と"
    ]
    # O-V 規則
    o_v_kentou_dic = {"obj": {"法", "法律", "規則", "対策", "方向性"},
                      "verb": {"整理", "まとめる", "整える", "分析", "見直す", "とりまとめる", "策定"}
                      }
    ...
    # O-V 規則
    o_v_houshin_dic = {"obj": {"目標", "方針", "計画", "目的", "アプローチ"},
