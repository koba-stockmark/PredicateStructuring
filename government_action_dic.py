class GovernmentActionRule:
    ...
    # O-V 規則
    o_v_kentou_dic = {"obj": {"法", "法律", "規則", "対策", "方向性", "提言", "意見", "結果", "戦略"},
    ...
    # O-V 規則
    o_v_houshin_dic = {"obj": {"目標", "方針", "計画", "目的", "アプローチ", "工程", "ガイドライン", "戦略"},
    ...
    # O-V 規則
    o_v_shisuu_dic = {"obj": {"比率", "比", "率", "量", "％", "トン", "円", "ドル", "人", "額", "価", "社", "安値", "高値", "位"},
                      "verb": {"なる", "固まる", "値下がり", "値上がり", "高い", "安い", "超える", "上昇", "下降", "落ちる",
                               "引き上げる", "引き下げる", "落ち込む", "修正", "下落", "突破"}
                      }
...
#        {"label": "<情報公開>", "words": koukai_dic},
    ...
    press_dic = ["促す", "発表", "公表", "策定", "抑え込む", "まとめる", "向ける", "求める", "広げる", "開く", "決める",
                 ...
                 "誘致", "判断", "盛り込む", "協議", "力を入れる", "取りかかる", "増やすように促す", "外す", "わかる"
                 ]
