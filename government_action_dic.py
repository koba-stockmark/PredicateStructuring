class GovernmentActionRule:
    ...
    # O-V 規則
    o_v_sekou_dic = {"obj": {"措置", "施策", "対策", "対応策", "制度"},
                     "verb": {"実施", "行う", "導入"}
                     }
    ...
    action_dic = [
        ...
        "調べる", "追加調査", "か調べる", "調査", "検査", "取りまとめる", "改める", "まとめる"
    ...
    # 方策作成 , "まとめる", "掲げる", "引き下げる", "引き上げる"
    sakusei_dic = [
        "作る", "作成", "一つにする", "策定", "改正", "施行", "改訂"
    ]
    # O-V 規則
    ...
    # 指数・統計
    shisuu_dic = [
        "回復", "上がる", "下がる", "増える", "増加", "減る", "減少", "上回る", "下回る", "割高", "削減", "加える"
        "1位", "2位", "3位", "4位", "5位", "6位", "7位", "8位", "9位",
        "1回", "2回", "3回", "4回", "5回", "6回", "7回", "8回", "9回"
    ]
    # O-V 規則
    ...
    shisuu = ["<指数>"]
    kaigi = ["<会談>", "<派遣>"]
    sonota = ["<システム管理>", "<支援>", "<期日>", "<契約>", "<背景>", "<所見>", "<創立>", "<連携>", "<情報公開>", "<イベント>"]
