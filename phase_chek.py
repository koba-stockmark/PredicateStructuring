...
kenkyuu_dic = [
"解析研究","確認","確立","企画、開発","研究","研究・開発","発明"

]

kaihatsu_dic = [
"アプリ開発","開発","開発、受注販売","開発・提供","開発・納入","開発支援","開発中","開発提供","企画・開発","企画及び開発",
    "技術開発","共同開発","共同開発・投資","建設","建築","構築","自社開発","商品開発","設計","開発・運営","開発・実証",
    "開発・販売","研究・開発","再資源化技術開発","展開・開発"
]
...
"12商品発売","2,489店舗展開","20店舗展開","2機種販売","2種類発売","2店舗同時オープン","6機種発売","90店舗展開","API提供",
    ...
    "展開・開発","販売及び技術サポート","販路開拓支援","無償ダウンロード提供"
]
...
"API連携","シングルサインオン連携","データ連携","連携","プロジェクト受付","プロデュース","果たす","供給","共同開発・投資",
    ...
    "投資募集","納入","募る","募集","融合","預かる","連載","連載","接続","相互運用性試験","提携"
]
...
"延期","確認","決定","示す","承認","申請","制定","設定","設立","操縦","定義","提案","提案","提示","提出","検討",
    "締結","登録予約","投資募集","統一","認める","認証","予約","預かる","立案","グローバル事前登録","先行予約受付"
